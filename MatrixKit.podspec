Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/matrix-org/matrix-ios-kit.git", :tag => "v0.4.7" }
  ...
  s.dependency 'GHMarkdownParser', :git => "https://github.com/VictorLiubchenko/GHMarkdownParser.git"
